        ...
        <?php include("../includes/nav.php"); ?>
            ...
            <main>
                <div class="wrapper-bleu texte_fonce">
                    ...
                    <div class="flex_contain">
                        <div class="flex_part">
                            <div class="div_part"> <img src="../images/part1.jpg"> </div>
                            <div class="div_part">
                        ...
                        <div class="flex_part">
                            <div class="div_part"> <img src="../images/part2.jpg"> </div>
                            <div class="div_part">
                                <div class="part_texte">
                        ...
                        <div class="flex_part">
                            <div class="div_part"> <img src="../images/part3.jpg"> </div>
                            <div class="div_part">
                                <div class="part_texte">
                        ...
                        <div class="flex_part">
                            <div class="div_part"> <img src="../images/part4.jpg"> </div>
                            <div class="div_part">
                                <div class="part_texte">
