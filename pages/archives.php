                           ...
                           <!-------------->
                            <div class="block archives 2016 nathan" data-cat="2016 nathan">
                                ...
                                <div class="block-hidden">
                                    <p> Nathan avait eu l’occasion de l’expérimenter à maintes reprises, toujours avec ravissement et ses camarades en sont tout aussi ravis. </p>
                                    <p> Nos amis de l’association "Osons la différence", secondés par les « Dunes d’espoir », habitués à transporter des enfants en situation de handicap moteur, ont offert ce tour dans la nature à un public d’enfants mal et non-voyants. Ils ont osé la différence pour le plus grand bonheur de nos participants. </p>
                                    <p> Les enfants sont montés à tour de rôle, un peu étonnés pour certains, mais bien rapidement conquis par ces sensations nouvelles. </p>
                                    <p> Il y a eu d’autres surprises: le rallye dans la nature automnale et la montée dans l’enceinte du château fort, au son de l’épinette de Alain Christophe, troubadour pour ce jour. </p>
                                    <p> Un pique-nique dans un air un peu vif; au retour était programmé un essai avec les GPS mais au diable le progrès, place à ce véhicule magique. </p>
                                    <p> Les associations partenaires sont reparties pour une après-midi sportive et donner le sourire à Valentin. Merci à eux… et vraiment, ça vaut la peine : « osons la différence » </p>
                                </div>
                            ...
                            <div class="block archives 2016 vie" data-cat="2016 vie">
                                <div class="partie_visible">
                                    ...
                                    <p> Réservez le 12 octobre pour le film documentaire de Kombissiri. </p>
                                    <p> C’est un beau regard sur l’Afrique : on y admire le formidable travail qu’y ont réalisé les Association Yvoir et Vélo pour le Faso. Les deux associations et toute l’équipe de tournage ont fait un travail remarquable, dans des conditions pas toujours faciles. </p>
                                </div>
                                <div class="block-hidden">
                                    <p> Yvoir est une association partenaire qui soutient et accompagne « Vue du coeur » </p>
                                    <p> Vous trouverez ci-dessous l’invitation de Gérard et François. </p>
                                    <p> Chers amis, </p>
                                    <p> Yvoir et Vélos pour le Faso ont le plaisir de vous convier à la première projection du film « Kombissiri » à Strasbourg le 12 octobre prochain. </p>
                                    <p> Ce film extraordinaire, réalisé par René Letzgus (star production) avait été diffusé en mai dernier en ouverture du festival « Cannes Cinéphile ». Il relate notamment le travail de Yvoir et Vélos pour le Faso au Burkina Faso, où nous avons notamment créé la première course handisport en tandem d’Afrique de l’Ouest. </p>
                                    <p> Ce film revêt une importance particulière pour nos deux associations puisqu’il permet de lever des fonds afin d’opérer toujours plus de personnes de la cataracte à l’hôpital de Kombissiri. Ce sont déjà des dizaines de personnes qui vont pouvoir être opérées et retrouver la vue grâce a lui. </p>
                                    <p> Il sera projeté le 12 octobre prochain à partir de 19h45 au cinéma Vox à Strasbourg. </p>
                                    <p> Nous espérons vous y retrouver le plus nombreux possible ! Et nous comptons sur vous pour faire connaître cet événement autour de vous. </p>
                                    <p> Avec toute notre amitié </p>
                                    <p> Gérard Muller, président d’Yvoir et François Orsat, prèsident de Vélos pour le Faso </p>
                                    <p> Avec toute notre amitié </p>
                                    <p> Suivez-nous sur Facebook : </p>
                                    <p> Association Yvoir – Gérard Muller </p>
                            ...
                            <div class="block archives 2016 nathan" data-cat="2016 nathan">
                                ...
                                <div class="block-hidden">
                                    <p> Mais Clément a expliqué que avant de se servir de l’outil de navigation, il faut se servir de ses jambes, de sa tête, autrement dit, savoir mesurer des distances en comptant ses pas, savoir suivre et retrouver quelqu’un ..savoir tourner comme une montre. Tout cela ce soir-là en s’amusant, en marquant des points. Tout cela aussi en jouant ensemble, voyants et non voyants pour apprendre les uns des autres. </p>
                                    <p> Une soirée toute douce, on aurait dit que l’été nous a attendus avant de tirer sa révérence, nous càd notre petit groupe, les parents frères et sœurs et des bénévoles de « Vue du cœur ». </p>
                                    <p> On a ainsi pu jouer les prolongations et ce n’est qu’à la tombée de la nuit que le groupe s’est séparé. Promis » on reviendra »! Nous aussi pour la prochaine séance au début des vacances de la Toussaint Et si on arrivait à vous donner l’envie de vous retrouver et vous donner un peu des ailes … </p>
                                </div>
                                <div class="bouton-jaune"> Lire la suite </div>
                            </div>
